...
const MAP: Record<ThemeName, ChromeTheme> = {
  ...
  epf: {
    barScrolled: "bg-[#f7f7f8]/80 backdrop-blur-xl border-b border-[#d6d6db] text-[#0a0a0b]",
    barTop: "bg-[#f7f7f8]/80 backdrop-blur-xl border-b border-[#d6d6db] text-[#0a0a0b]",
    brand: "text-[#0a0a0b]",
    tag: "text-[#5c5c60]",
    dot: "bg-[#0a0a0b]",
    navLink: "text-[#5c5c60] hover:text-[#0a0a0b]",
    activeLink: "text-[#0a0a0b]",
    divider: "bg-[#d6d6db]",
    pill: "bg-white/70 text-[#0a0a0b] border border-[#d6d6db]",
    dropdown: "bg-white/90 backdrop-blur-xl border-[#d6d6db] text-[#0a0a0b]",
    dropdownItemHover: "hover:bg-[#ededf0]",
    drawer: "bg-[#f7f7f8] text-[#0a0a0b]",
    footerBg: "bg-[#f7f7f8] text-[#0a0a0b]",
    footerRule: "border-[#d6d6db]",
    footerFaint: "text-[#5c5c60]",
    footerChip: "bg-white/70 text-[#0a0a0b] border border-[#d6d6db]",
  },
  global: GLOBAL,
  swiggy: SWIGGY,
